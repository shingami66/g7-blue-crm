...
const valid = { supplierId: "00000000-0000-4000-8000-000000000001", category: "sound", itemName: "PA System", unit: "day", currency: "SAR", baseCost: "125.50", validFrom: "2026-01-01", validTo: null, notes: null, status: "inactive" };
...
test("rate-card update keeps identity fields and dates validated", () => {
  const update = { supplierId: valid.supplierId, category: valid.category, itemName: valid.itemName, unit: valid.unit, currency: valid.currency, baseCost: valid.baseCost, validFrom: valid.validFrom, validTo: valid.validTo, notes: valid.notes };
