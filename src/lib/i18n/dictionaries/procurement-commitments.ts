...
const english: ProcurementCommitmentDictionary = {
  ...
  errors: {
    service_receipt_self_review_forbidden: "A different authorized reviewer must review this receipt unless you are an Admin.",
