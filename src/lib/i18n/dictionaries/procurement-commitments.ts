...
const english: ProcurementCommitmentDictionary = {
  ...
  errors: {
    ...
    service_receipt_value_exceeds_open: "The receipt value exceeds the remaining authorized commitment.", service_receipt_commitment_not_open: "This commitment is not open for a new receipt.", service_receipt_already_reviewed: "This receipt has already been reviewed.", service_receipt_not_reviewed: "Only a reviewed receipt can be corrected.", service_receipt_correction_request_conflict: "This correction request was already used with different data.", service_receipt_correction_invalid: "Provide a valid corrected outcome, value, and reason.", service_receipt_correction_permission_denied: "You do not have permission to correct a reviewed receipt.",
