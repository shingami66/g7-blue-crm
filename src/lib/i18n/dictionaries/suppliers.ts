...
export interface SuppliersDictionary {
  ...
  quotationHistory: {
    ...
    noRequirementsOnQuotation: string;
    supplierReference: string;
    unknownSupplierReference: string;
    quotationDate: string;
    unknownQuotationDate: string;
    packageTotal: string;
    lineAmount: string;
    scopeSummary: string;
    legacyEvidenceReference: string;
    currency: string;
    originalDocuments: string;
    noDocuments: string;
    documentsUnavailable: string;
    documentsRestricted: string;
    documentSingular: string;
    documentPlural: string;
    legacyRecordedEvidence: string;
    legacyDetailNotice: string;
    documentHelper: string;
    requirementSelectionRequired: string;
    view: string;
    ...
    chooseRequirements: string;
    requirementLines: string;
    existingQuotation: string;
    supplierReferencePlaceholder: string;
    packageTotalPlaceholder: string;
    lineSummaryPlaceholder: string;
    ...
    requirementsLoadFailed: string;
    chooseFiles: string;
    noFilesSelected: string;
    quotationDatePlaceholder: string;
    openCalendar: string;
    pricingMode: string;
    totalOnly: string;
    ...
    addLine: string;
    removeLine: string;
    addFromRequirements: string;
    allRequirementsAdded: string;
...
const suppliersDictionaryEn: SuppliersDictionary = {
  ...
  rateCards: { loading: "Loading rate cards...", loadFailed: "Failed to load rate cards. Please try again.", empty: "No rate cards recorded for this supplier.", create: "Add rate card", edit: "Edit", save: "Save rate card", cancel: "Cancel", activate: "Activate", deactivate: "Deactivate", category: "Category", itemName: "Item", unit: "Unit", pricingBasis: "Pricing Basis", currency: "Currency", baseCost: "Base cost", status: "Status", notes: "Notes", overlap: "An active rate card already covers {itemName} ({unit}) from {validFrom} to {validTo}.", validation: "Please check the rate card fields.", actionFailed: "The rate card could not be saved. Please try again.", saved: "Rate card saved.", activated: "Rate card activated.", deactivated: "Rate card deactivated.", perUnit: "per {unit}", validFrom: "Valid From", validTo: "Valid To", current: "Open-ended", active: "Active", inactive: "Inactive" },
  quotationHistory: { title: "Supplier Quotation History", openWorkspace: "Open quotation workspace", addQuotation: "Add supplier quotation", newTitle: "New Supplier Quotation", newSubtitle: "Record one supplier quotation with its covered Service requirements and original evidence.", createUnavailable: "Supplier quotations can only be added for an active supplier.", detailTitle: "Supplier Quotation", detailSubtitle: "Historical supplier quotation evidence linked to a Service.", backToHistory: "Back to quotation history", supplier: "Supplier", subtitle: "Historical supplier quotation records linked to Services. These records do not create a Booking or commitment.", empty: "No supplier quotations have been recorded for this supplier.", loadFailed: "Supplier quotation history could not be loaded.", service: "Service / Event", actions: "Actions", recorded: "Recorded date", event: "Event", requirement: "Procurement requirement", requirements: "Quotation requirements", coveredRequirements: "Requirements", noRequirementsOnQuotation: "No procurement requirements are attached to this quotation.", supplierReference: "Supplier quotation reference", unknownSupplierReference: "Unknown supplier reference", quotationDate: "Quotation date", unknownQuotationDate: "Unknown quotation date", packageTotal: "Package total", lineAmount: "Line amount", scopeSummary: "Line scope / summary", legacyEvidenceReference: "Legacy candidate evidence reference", currency: "Currency", originalDocuments: "Original documents", noDocuments: "No original document attached.", documentsUnavailable: "Original documents are unavailable while the linked Service is deleted.", documentsRestricted: "Document access is unavailable.", documentSingular: "original document", documentPlural: "original documents", legacyRecordedEvidence: "Legacy recorded evidence", legacyDetailNotice: "Compatibility record: the supplier reference and supplier quotation date were not present in the legacy evidence. The recorded date below is the system record date.", documentHelper: "Original documents are optional and remain in private document storage.", requirementSelectionRequired: "Choose at least one Service requirement.", view: "View", navigationPending: "Opening supplier quotation...", viewOriginal: "View original", loadingOriginal: "Preparing private link…", viewFailed: "The private document link could not be created.", recordTitle: "Record supplier quotation", chooseService: "Choose a Service", serviceSelection: "Service Selection", serviceLabel: "Service", selectServicePlaceholder: "Select a Service…", chooseRequirements: "Choose one or more requirements", requirementLines: "Quotation requirement lines", existingQuotation: "Existing quotation", supplierReferencePlaceholder: "Supplier's quote number or reference…", packageTotalPlaceholder: "Optional package total", lineSummaryPlaceholder: "Describe the supplier's scope for this requirement…", lineAmountPlaceholder: "Optional line amount", save: "Save supplier quotation", saving: "Saving supplier quotation…", saved: "Supplier quotation saved.", actionFailed: "The supplier quotation could not be saved.", noRequirements: "No active Service procurement requirements are available for this supplier.", requirementsLoadFailed: "Service requirements could not be loaded.", chooseFiles: "Choose files", noFilesSelected: "No files selected", quotationDatePlaceholder: "YYYY-MM-DD", openCalendar: "Open calendar", pricingMode: "Pricing Mode", totalOnly: "Total Only", detailedItems: "Itemized Lines", itemDescription: "Description", packageRequirement: "Package Requirement", quantity: "Quantity", unit: "Unit", unitPrice: "Unit Price", lineTotal: "Line Total", subtotal: "Subtotal", quotationTotal: "Quotation Total", addLine: "Add Line", removeLine: "Remove line", addFromRequirements: "Add from Package Requirements", allRequirementsAdded: "All Package Requirements Added", reconciliationMismatch: "Line total must match quantity multiplied by unit price.", linesRequired: "At least one line item is required for detailed pricing.", totalRequired: "Total amount is required for total-only pricing.", optionalLink: "Optional Package Requirement Link", unlinkedLine: "None", detailedPricing: "Itemized Lines", totalOnlyPricing: "Total Only", legacyPricing: "Legacy Requirements", serviceUnavailable: "The selected Service is not eligible for recording supplier quotations.", noEligibleServices: "No eligible Services are available for recording supplier quotations." },
...
const suppliersDictionaryAr: SuppliersDictionary = {
  ...
  rateCards: { loading: "جارٍ تحميل بطاقات الأسعار...", loadFailed: "تعذر تحميل بطاقات الأسعار. يرجى المحاولة مرة أخرى.", empty: "لا توجد بطاقات أسعار مسجلة لهذا المورد.", create: "إضافة بطاقة سعر", edit: "تعديل", save: "حفظ بطاقة السعر", cancel: "إلغاء", activate: "تفعيل", deactivate: "إلغاء التفعيل", category: "الفئة", itemName: "العنصر", unit: "الوحدة", pricingBasis: "أساس التسعير", currency: "العملة", baseCost: "التكلفة الأساسية", status: "الحالة", notes: "ملاحظات", overlap: "توجد بطاقة سعر نشطة تغطي {itemName} ({unit}) من {validFrom} إلى {validTo}.", validation: "يرجى التحقق من حقول بطاقة السعر.", actionFailed: "تعذر حفظ بطاقة السعر. يرجى المحاولة مرة أخرى.", saved: "تم حفظ بطاقة السعر.", activated: "تم تفعيل بطاقة السعر.", deactivated: "تم إلغاء تفعيل بطاقة السعر.", perUnit: "لكل {unit}", validFrom: "ساري من", validTo: "ساري حتى", current: "مفتوحة النهاية", active: "نشط", inactive: "غير نشط" },
  quotationHistory: { title: "سجل عروض أسعار المورد", openWorkspace: "فتح مساحة عروض الأسعار", addQuotation: "إضافة عرض سعر مورد", newTitle: "عرض سعر مورد جديد", newSubtitle: "تسجيل عرض سعر مورد واحد مع متطلبات الخدمة التي يغطيها وأدلته الأصلية.", createUnavailable: "يمكن إضافة عروض أسعار الموردين للمورد النشط فقط.", detailTitle: "عرض سعر المورد", detailSubtitle: "دليل عرض سعر مورد تاريخي مرتبط بخدمة.", backToHistory: "العودة إلى سجل عروض الأسعار", supplier: "المورد", subtitle: "سجلات عروض أسعار المورد التاريخية المرتبطة بالخدمات. لا تنشئ هذه السجلات حجزًا أو التزامًا.", empty: "لم يتم تسجيل عروض أسعار لهذا المورد.", loadFailed: "تعذر تحميل سجل عروض أسعار المورد.", service: "الخدمة / الفعالية", actions: "إجراءات", recorded: "تاريخ التسجيل", event: "الفعالية", requirement: "متطلب التوريد", requirements: "متطلبات عرض السعر", coveredRequirements: "المتطلبات", noRequirementsOnQuotation: "لا توجد متطلبات توريد مرتبطة بعرض السعر هذا.", supplierReference: "مرجع عرض سعر المورد", unknownSupplierReference: "مرجع المورد غير معروف", quotationDate: "تاريخ عرض السعر", unknownQuotationDate: "تاريخ عرض السعر غير معروف", packageTotal: "إجمالي الحزمة", lineAmount: "مبلغ السطر", scopeSummary: "نطاق / ملخص السطر", legacyEvidenceReference: "مرجع دليل المرشح القديم", currency: "العملة", originalDocuments: "المستندات الأصلية", noDocuments: "لم يتم إرفاق مستند أصلي.", documentsUnavailable: "لا تتوفر المستندات الأصلية أثناء حذف الخدمة المرتبطة.", documentsRestricted: "الوصول إلى المستندات غير متاح.", documentSingular: "مستند أصلي", documentPlural: "مستندات أصلية", legacyRecordedEvidence: "دليل تاريخي مسجل", legacyDetailNotice: "سجل توافق: لم يكن مرجع المورد وتاريخ عرض السعر متوفرين في الدليل القديم. التاريخ المعروض أدناه هو تاريخ تسجيل السجل في النظام.", documentHelper: "المستندات الأصلية اختيارية وتبقى في التخزين الخاص للمستندات.", requirementSelectionRequired: "اختر متطلب خدمة واحدًا على الأقل.", view: "عرض", navigationPending: "جارٍ فتح عرض سعر المورد...", viewOriginal: "عرض الأصل", loadingOriginal: "جارٍ تجهيز الرابط الخاص…", viewFailed: "تعذر إنشاء رابط المستند الخاص.", recordTitle: "تسجيل عرض سعر المورد", chooseService: "اختر خدمة", serviceSelection: "اختيار الخدمة", serviceLabel: "الخدمة", selectServicePlaceholder: "اختر خدمة…", chooseRequirements: "اختر متطلبًا واحدًا أو أكثر", requirementLines: "سطور متطلبات عرض السعر", existingQuotation: "عرض سعر موجود", supplierReferencePlaceholder: "رقم أو مرجع عرض السعر لدى المورد…", packageTotalPlaceholder: "إجمالي الحزمة اختياري", lineSummaryPlaceholder: "صف نطاق المورد لهذا المتطلب…", lineAmountPlaceholder: "مبلغ السطر اختياري", save: "حفظ عرض سعر المورد", saving: "جارٍ حفظ عرض سعر المورد…", saved: "تم حفظ عرض سعر المورد.", actionFailed: "تعذر حفظ عرض سعر المورد.", noRequirements: "لا توجد متطلبات توريد نشطة متاحة لهذا المورد.", requirementsLoadFailed: "تعذر تحميل متطلبات الخدمة.", chooseFiles: "اختيار الملفات", noFilesSelected: "لم يتم اختيار ملفات", quotationDatePlaceholder: "YYYY-MM-DD", openCalendar: "فتح التقويم", pricingMode: "طريقة التسعير", totalOnly: "الإجمالي فقط", detailedItems: "بنود مفصلة", itemDescription: "الوصف", packageRequirement: "متطلب الباقة", quantity: "الكمية", unit: "الوحدة", unitPrice: "سعر الوحدة", lineTotal: "إجمالي السطر", subtotal: "المجموع الفرعي", quotationTotal: "إجمالي عرض السعر", addLine: "إضافة بند", removeLine: "حذف البند", addFromRequirements: "إضافة من متطلبات الباقة", allRequirementsAdded: "كل متطلبات الباقة مضافة", reconciliationMismatch: "يجب أن يتطابق إجمالي السطر مع حاصل ضرب الكمية في سعر الوحدة.", linesRequired: "يلزم إدخال بند واحد على الأقل للتسعير المفصل.", totalRequired: "المبلغ الإجمالي مطلوب للتسعير الإجمالي فقط.", optionalLink: "ربط اختياري بمتطلب باقة", unlinkedLine: "غير مرتبط", detailedPricing: "بنود مفصلة", totalOnlyPricing: "الإجمالي فقط", legacyPricing: "متطلبات سابقة", serviceUnavailable: "الخدمة المحددة غير مؤهلة لتسجيل عروض أسعار الموردين.", noEligibleServices: "لا توجد خدمات مؤهلة لتسجيل عروض أسعار الموردين." },
