...
export interface Customer360Dictionary {
  ...
  states: { forbidden: string; error: string; empty: string; noUpcoming: string; noActivity: string };
...
const en: Customer360Dictionary = {
  ...
  states: { forbidden: "This information is not available for your role.", error: "This information could not be loaded.", empty: "No records found.", noUpcoming: "No upcoming services.", noActivity: "No recent activity." },
...
const ar: Customer360Dictionary = {
  ...
  states: { forbidden: "هذه المعلومات غير متاحة لدورك.", error: "تعذر تحميل هذه المعلومات.", empty: "لا توجد سجلات.", noUpcoming: "لا توجد خدمات قادمة.", noActivity: "لا توجد نشاطات حديثة." },
