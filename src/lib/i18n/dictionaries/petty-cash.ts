...
const en: PettyCashDictionary = {
  ...
  labels: {
    ...
    availableCash: "Available cash", replenishmentCapacity: "Replenishment Capacity", lastActivity: "Last activity", status: "Status", viewFund: "View fund",
