...
const en: PettyCashDictionary = {
  ...
  labels: {
    ...
    replenishmentCapacity: "Replenishment Capacity", lastActivity: "Last activity", status: "Status", action: "Action", viewFund: "View fund",
    ...
    amount: "Amount", date: "Date", context: "Context", category: "Category", description: "Description", review: "Finance review", approved: "Approved", disbursed: "Disbursed", allocated: "Allocated", remaining: "Remaining",
  },
...
const ar: PettyCashDictionary = {
  ...
  actions: { manage: "إدارة الصندوق", replenish: "إعادة تغذية", recordExpense: "تسجيل مصروف", disburse: "صرف المصروف المعتمد", withdraw: "إرجاع النقد للخزينة", suspend: "إيقاف", reactivate: "إعادة تفعيل", close: "إغلاق", save: "حفظ", cancel: "إلغاء", create: "إنشاء", working: "جارٍ التنفيذ...", retryReceipt: "إعادة رفع الإيصال", openExpenseWorkspace: "فتح مساحة المصروفات", approveAndDisburse: "اعتماد وصرف" },
