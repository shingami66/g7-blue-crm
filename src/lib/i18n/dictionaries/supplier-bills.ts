...
const errorsEn: Record<string, string> = {
  ...
  supplier_bill_fields_invalid: "Check the invoice dates and amounts.",
  ...
  supplier_bill_self_approval_forbidden: "The person who recorded the bill cannot approve it.",
...
const errorsAr: Record<string, string> = {
  ...
  supplier_bill_fields_invalid: "تحقق من تواريخ الفاتورة ومبالغها.",
  ...
  supplier_bill_self_approval_forbidden: "لا يمكن لمن سجّل الفاتورة اعتمادها.",
...
export const supplierBillsDictionaryEn: SupplierBillsDictionary = {
  ...
  actions: { view: "View bill", create: "Record Supplier Bill", save: "Record Bill", saveChanges: "Save Changes", approve: "Approve", attachInvoice: "Attach Invoice", openDocument: "Open document" },
...
export const supplierBillsDictionaryAr: SupplierBillsDictionary = {
  ...
  actions: { view: "عرض الفاتورة", create: "تسجيل فاتورة مورد", save: "تسجيل الفاتورة", saveChanges: "حفظ التعديلات", approve: "اعتماد", attachInvoice: "إرفاق الفاتورة", openDocument: "فتح المستند" },
