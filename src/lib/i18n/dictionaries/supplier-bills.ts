...
export interface SupplierBillsDictionary {
  ...
  fields: {
    ...
    advanceAllocationHistory: string;
  };
  columns: {
    bill: string;
    supplier: string;
  ...
  advanceAllocationStatuses: Record<"allocated" | "corrected", string>;
...
export const supplierBillsDictionaryEn: SupplierBillsDictionary = {
  ...
  advanceAllocationStatuses: { allocated: "Allocated", corrected: "Corrected" },
...
export const supplierBillsDictionaryAr: SupplierBillsDictionary = {
  ...
  advanceAllocationStatuses: { allocated: "مطبقة", corrected: "مصححة" },
