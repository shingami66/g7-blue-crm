      ...
      <div className="flex items-center gap-4 py-4">
        ...
        <div>
          ...
          <p className="text-on-surface-variant text-[14px]">
            {service.serviceNumber} — Update service details.
          </p>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div className="bg-surface-container-lowest border border-surface-variant rounded-xl overflow-hidden p-6 flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <div className="w-full bg-surface-container-low border border-outline-variant rounded-lg px-3 py-2 text-[14px] text-on-surface-variant cursor-not-allowed">
                {service.customer?.company || "Unknown"} {service.customer?.contact ? `(${service.customer.contact})` : ""}
              </div>
            </div>
