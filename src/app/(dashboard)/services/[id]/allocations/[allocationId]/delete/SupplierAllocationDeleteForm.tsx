...
function getDeleteSupplierAllocationErrorMessage(
  error: string | null | undefined,
  dictionary: ReturnType<
    typeof getServicesDictionary
  >["supplierAllocations"]["subflow"]["deleteForm"]
) {
  if (!error) {
...
export default function SupplierAllocationDeleteForm({
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    if (result.success) {
      ...
      setError(getDeleteSupplierAllocationErrorMessage(result.error, dictionary));
      setIsLoading(false);
    }
  }
