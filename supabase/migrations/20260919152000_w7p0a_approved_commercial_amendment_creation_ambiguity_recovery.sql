-- W7-P0A recovery after an external DEV review-repair reintroduced the
-- unqualified quotation_family_id ambiguity in the creation RPC.
-- This forward-only replacement restores the already reviewed function body.
