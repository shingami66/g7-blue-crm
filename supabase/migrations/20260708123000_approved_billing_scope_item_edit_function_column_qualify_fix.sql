-- Approved Billing Scope Item Edit Atomic Function Column Qualify Fix
-- Purpose:
--   Fix PL/pgSQL name collision where "accepted_subtotal", "accepted_vat_amount",
--   and "accepted_grand_total" in the SUM() aggregation query were unqualified,
--   conflicting with the RETURNS TABLE output parameter names.
--
-- IMPORTANT:
--   - This corrective migration must be applied manually in DEV/DEMO.
