...
### LIST-PAGINATION-PARITY-1
Status: Partially complete (Customers done, Services pending)

Checklist:
- [x] Customers list: 10 rows per page.
- [ ] Services list: 10 rows per page.
- [x] Previous / Next controls when count exceeds 10. (Customers done, Services pending)
- [x] Preserve search/filter behavior across pages. (Customers done, Services pending)
