...
### CUSTOMER-NUMBER-1
Status: Pending before or early ERP-3

Checklist:
- [ ] Generate customer number/code (e.g. `CUST-2026-0001`).
- [ ] Add customer number/code without breaking existing IDs or foreign keys.
- [ ] Show in customers list.
- [ ] Show in customer detail.
- [ ] Use in future invoice/payment/document selection where useful.
- [ ] Generated by system, not manually entered.

### LIST-PAGINATION-PARITY-1
Status: Pending/deferred after ERP-3 unless quick

Checklist:
- [ ] Customers list: 10 rows per page.
- [ ] Services list: 10 rows per page.
- [ ] Previous / Next controls when count exceeds 10.
