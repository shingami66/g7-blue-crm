...
- **Current active work — P8:** **SHARED / COLD-SHELL WORK**. Begin with evidence-led examination of broad shared/cold-layout work, including business-year discovery and other cross-route shell costs. Caching, precomputation, infrastructure, and other architectural treatments remain unselected until evidence supports one.
...
`Customer360 P0 closure (complete) -> P1 shared record-navigation closeout (complete) -> P2 detail-page responsiveness architecture (complete/published) -> P3 data-access round-trip reduction (complete/published) -> P4 related-record UX bounding (complete/published) -> P5 narrow read models / projections (complete/published) -> P6 scale-safe financial read models (complete/published/verified) -> P7 large secondary collections (complete/published/verified) -> P8 shared / cold-shell work (active evidence-led examination) -> scale rerank/acceptance -> production hardening -> UAT -> handoff`

**Current delivery priority:** P0-P7 are complete, published, and verified. P8 shared / cold-shell work is active for evidence-led examination of business-year discovery and other cross-route shell costs; it does not preselect caching, precomputation, infrastructure, or a shared-layout architecture. Feature 008, the latest Quotation/Invoice UX batch, and ABS management UI including Void remain delivered. ABS Supersede remains inactive pending formal feature activation, fresh current-state verification, and bounded planning. Do not promote Reports Center, Clerk invitation/webhook smoke, or production hardening as complete; those remain sequenced work and readiness gates.
