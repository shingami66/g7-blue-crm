...
- **Current active work — P9:** **DATA-LAYER ATTRIBUTION**. Begin with the roadmap's own evidence-led attribution contract; do not preselect a query, RPC, index, table, route, or optimization.
...
**Current delivery priority:** P0-P8 are complete, published, and verified. P9 **DATA-LAYER ATTRIBUTION** is active for its own evidence-led distinction of data/API, execution, transfer/serialization, and application-orchestration cost; it does not preselect a database target or treatment. Feature 008, the latest Quotation/Invoice UX batch, and ABS management UI including Void remain delivered. ABS Supersede remains inactive pending formal feature activation, fresh current-state verification, and bounded planning. Do not promote Reports Center, Clerk invitation/webhook smoke, or production hardening as complete; those remain sequenced work and readiness gates.
