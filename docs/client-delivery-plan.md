...
- **Current active work — P7:** **LARGE SECONDARY COLLECTIONS**, exact task `G7-SAAS-PERFORMANCE-P7-LARGE-SECONDARY-COLLECTIONS-01`. P7 begins with current evidence, cardinality/use analysis, and prioritization of Service Quotations, allocations, bookings, and other high-cardinality secondary collections. No solution or implementation is pre-authorized.
...
`Customer360 P0 closure (complete) -> P1 shared record-navigation closeout (complete) -> P2 detail-page responsiveness architecture (complete/published) -> P3 data-access round-trip reduction (complete/published) -> P4 related-record UX bounding (complete/published) -> P5 narrow read models / projections (complete/published) -> P6 scale-safe financial read models (complete/published/verified) -> P7 large secondary collections (active evidence/cardinality analysis) -> scale rerank/acceptance -> production hardening -> UAT -> handoff`

**Current delivery priority:** P0 Customer360 invoice-loading closeout, P1 shared record-navigation closeout, P2 detail-page responsiveness architecture, P3 data-access round-trip reduction, P4 related-record UX bounding, P5 narrow read models / projections, and P6 scale-safe financial read models are complete and published. P7 large secondary collections is active as `G7-SAAS-PERFORMANCE-P7-LARGE-SECONDARY-COLLECTIONS-01`; continue one bounded task at a time with current evidence, cardinality/use analysis, and prioritization. It does not preselect a treatment or absorb generic shared-detail/entity-contract redesign. Feature 008, the latest Quotation/Invoice UX batch, and ABS management UI including Void remain delivered. ABS Supersede remains inactive pending formal feature activation, fresh current-state verification, and bounded planning. Do not promote Reports Center, Clerk invitation/webhook smoke, or production hardening as complete; those remain sequenced work and readiness gates.
