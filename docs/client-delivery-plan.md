...
- **Current active work — P5:** **NARROW READ MODELS / PROJECTIONS**, exact task `G7-SAAS-PERFORMANCE-P5-NARROW-READ-MODELS-AND-PROJECTIONS-01`. P5 is **ACTIVE** and P6-P10 are **NOT STARTED / FUTURE PROGRAM PHASES**. Scope begins with field-use verification for material projections and broad joins, focused tests, and independent review.
...
`Customer360 P0 closure (complete) -> P1 shared record-navigation closeout (complete) -> P2 detail-page responsiveness architecture (complete/published) -> P3 data-access round-trip reduction (complete/published) -> P4 related-record UX bounding (complete/published) -> P5 narrow read models / projections (active) -> scale rerank/acceptance -> bounded financial implementation -> production hardening -> UAT -> handoff`

**Current delivery priority:** P0 Customer360 invoice-loading closeout, P1 shared record-navigation closeout, P2 detail-page responsiveness architecture, P3 data-access round-trip reduction, and P4 related-record UX bounding are complete and published. P5 narrow read models / projections is active as `G7-SAAS-PERFORMANCE-P5-NARROW-READ-MODELS-AND-PROJECTIONS-01`; continue one bounded task at a time with evidence, measurement, and validation. Feature 008, the latest Quotation/Invoice UX batch, and ABS management UI including Void remain delivered. ABS Supersede remains inactive pending formal feature activation, fresh current-state verification, and bounded planning. Do not promote Reports Center, Clerk invitation/webhook smoke, or production hardening as complete; those remain sequenced work and readiness gates.
