...
- **Smoke verification:** first create succeeded with `scopeId = 2fb8a324-4bd2-44be-8a23-a2b37e9b6e72`; duplicate second click returned `scope_duplicate_draft`; cleanup verification returned zero remaining scope and item rows.
