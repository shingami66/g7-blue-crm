...
## Vendors / Suppliers
- **Status:** Design direction and supplier directory DB foundation resolved; supplier implementation deferred.
...
- **Still deferred:** Live supplier UI, supplier data layer/actions, supplier CRUD, supplier rate cards, service supplier allocations/costing, supplier bookings/internal POs, supplier invoices/payments, Supplier PO PDF, WhatsApp/email, supplier portal, invoice attachments, supplier payment approval workflow, rate-card-driven quotation automation, automatic margin reports, and any future supplier SQL/migrations beyond the completed directory foundation.
