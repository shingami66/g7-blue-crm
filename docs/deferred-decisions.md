...
- **Supplier Booking:** DB foundation complete (`SUPPLIER-BOOKINGS-FOUNDATION-1`). Domain, UI, permissions, actions, and runtime behavior are explicitly deferred. Terminology constraint: Always use Supplier Booking / SBK. Do not use Internal PO / Purchase Order.
