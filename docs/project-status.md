...
- **Program state:** P0 is **COMPLETE / PUBLISHED / VALIDATED**; P1 is **COMPLETE / PUBLISHED / VERIFIED**; P2 is **COMPLETE / PUBLISHED / VERIFIED**; P3 is **COMPLETE / PUBLISHED / VERIFIED**; P4 is **COMPLETE / PUBLISHED / VERIFIED**; P5 is **COMPLETE / PUBLISHED / VERIFIED**; P6 is **COMPLETE / PUBLISHED / VERIFIED**; P7 is **COMPLETE / PUBLISHED / VERIFIED**; P8 is **ACTIVE — SHARED / COLD-SHELL WORK**; P9-P10 are **NOT STARTED / FUTURE PROGRAM PHASES**.
...
- **P8 — ACTIVE:** **SHARED / COLD-SHELL WORK** begins with evidence-led examination of business-year discovery and other cross-route shell costs. Caching, precomputation, infrastructure, and shared-layout architecture remain unselected until evidence identifies a material bottleneck.
...
- **Next-work boundary:** The active evidence-backed engineering priority is P8 shared / cold-shell work. P0-P7 are complete, published, and verified; generic shared-detail redesign remains future/evidence-gated until P8 evidence identifies a material bottleneck. Supersede, richer financial correction, Change Orders, and accounting expansion remain separately deferred.
