...
- **Next safe product/engineering direction:** The Invoices eligible-Service chooser is now the next product-planning direction, but it remains separately unauthorized. ABS history/read polish, Void UI, successor UI, and role browser smoke remain deferred.
