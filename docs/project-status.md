...
- **W7 — ACTIVE / NOT COMPLETE:** Accounts Receivable and downstream billing.
  ...
  - **W7-P0A Approved Commercial Amendment & Billing Authority Supersession Foundation — PUBLISHED / DEV VERIFIED / SOURCE-PARITY ESTABLISHED / CLOSEOUT READY**.
    ...
    - Final reconciliation established one governed repository source for every required current DEV financial behavior without rewriting historical migration files or applying a no-op DEV migration. W7-P0A is ready for the Controller verdict; this task does not start W7-P0B.
  ...
  - **EXACT NEXT ACTION:** `Obtain the Controller verdict on W7-P0A closeout; if approved in a separate task, design and implement the bounded W7-P0B owner-facing Commercial Amendment workflow using the locked flexible Quotation Commercial Model. Do not start W7-P0B or W7B in this task.`
