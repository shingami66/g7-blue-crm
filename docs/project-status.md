...
- **Current verified repository baseline (23 August 2026):** `main`, local HEAD, and `origin/main` are synchronized at `0aed85835501c24d7834401d8cc9f296cc9de5cf` (`0 ahead / 0 behind`). Unrelated local state is preserved. This HEAD publishes the completed P3 Customer 360 data-access round-trip reduction.
...
- **Program state:** P0 is **COMPLETE / PUBLISHED / VALIDATED**; P1 is **COMPLETE / PUBLISHED / VERIFIED**; P2 is **COMPLETE / PUBLISHED / VERIFIED**; P3 is **COMPLETE / PUBLISHED / VERIFIED**; P4 is **ACTIVE**; P5-P10 are **NOT STARTED / FUTURE PROGRAM PHASES** under the existing roadmap.
- **P4 — ACTIVE:** Program phase **RELATED-RECORD UX BOUNDING**; exact active engineering task: `G7-SAAS-PERFORMANCE-P4-RELATED-RECORD-UX-BOUNDING-01`. The Customer Detail related-invoice direction remains planned/documented and not implemented: show the latest 10 contextual invoices with View All to the dedicated Invoice workspace filtered to the current Customer. Preview size must never redefine authoritative financial summaries or financial activity.
...
- **Next-work boundary:** The active evidence-backed engineering priority is P4 related-record UX bounding (`G7-SAAS-PERFORMANCE-P4-RELATED-RECORD-UX-BOUNDING-01`). Supersede, richer financial correction, Change Orders, and accounting expansion remain separately deferred.
...
- **Workspace Location and Governance Rules:**
  ...
  - Canonical branch: `main`; current published checkpoint: `7507207c362c641b3c62aa7b1132fb6494fe1c0a`. The former `93d3f132b3ff756f4c49904da8622e40babdaa18` documentation-rebaseline authority and `90adf8f` discovery baseline remain historical evidence only.
