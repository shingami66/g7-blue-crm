...
- **W7 — ACTIVE / NOT COMPLETE:** Accounts Receivable and downstream billing.
  ...
  - **W7-P0B Owner-Facing Commercial Amendment Workflow — IMPLEMENTED / REVIEWED / DEV VERIFIED / PUBLISHED / OWNER MANUAL ACCEPTANCE PENDING / READY FOR CONTROLLER VERDICT**.
    ...
    - Focused tests, TypeScript, scoped ESLint, production build, deterministic OCR delegation, two independent substantive reviews, mediated challenge, targeted rereview, exact staging, commit, push, and final publication checks completed successfully. Owner manual acceptance remains pending.
  - W7B has not started.
