...
- **Exact next wave/action:** open the next separately authorized W2C Deterministic Discount Allocation / Approval Projection preflight; do not add another W1C feature unless new evidence proves it required.
...
- **Scope boundary:** customer-facing numbering and main-list behavior remain unchanged. No post-approval Change Order path, ABS supersession, reapproval, invoice/payment correction, or W2C behavior was introduced. W2C Deterministic Discount Allocation / Approval Projection preflight is the next separately authorized W2 action.
